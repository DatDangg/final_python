...
from .models import Product, Category, WishlistItem, CartItem, Address, Order, OrderItem, ProductImage
...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ("title", "brand", "image_count", "description", "cost_price", "listed_price", "SKU", "quantity", "category")
